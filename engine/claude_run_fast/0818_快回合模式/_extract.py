"""从子 agent 的 .output transcript 提取完整输出（思考+plan），落盘到 reasoning/。
...
FILES = [
    ("ad4242f97cebd1aa2", "north"),
    ("a5f29da78a04a8b94", "jin_1"),
    ("a9b8c77d26ba899a8", "jin_2"),
    ("ad263b6d8c36aa464", "jin_3"),
]
...
for agent_id, seat in FILES:
    ...
    with open(out, "w", encoding="utf-8") as f:
        ...
        f.write("> seed=20260819 · 快模式 + 回合级规划（每回合一次性规划整回合）\n")
